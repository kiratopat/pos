...
VALUES ('Type 1'),
       ...
       ('Type 4'),
       ('Type 5');
INSERT INTO Employee (fname, lname, tel, role)
VALUES ('John', 'Doe', '1234567890', 'Manager'),
       ('Jane', 'Doe', '0987654321', 'Sales'),
       ('Bob', 'Smith', '1122334455', 'Cashier'),
       ('Sara', 'Johnson', '6677889900', 'Manager'),
       ('Mike', 'Williams', '3344112233', 'Sales');
